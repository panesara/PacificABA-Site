            ...
            <div className="mb-20">
              <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
                ...
                <div className="order-1 lg:order-2">
                  <img
                    src="https://d2xsxph8kpxj0f.cloudfront.net/310519663345785943/AvwZ782cpoEQkTwQwTz254/pre-diagnostic-intervention-illustration-jofE6cameZHQu8PBQSKqPU.webp"
